...
10.	Create a button Download video. by clicking it execute the shell command in ffmpg_cmd string.
11.	On error displays the error in log textbox with E prefix. The log should be at the bottom of the page.
